"""Configuration loader for roboarm_grasp skill."""
...
def init_config(
    ...
    *,
    ...
    _ASSETS_ROOT = Path(assets_root).resolve() if assets_root else _CONFIG_PATH.parent.parent / "assets"
    return CONFIG
...
def get_config_value(
    ...
    *,
    ...
    if key == "llm_api_key" and (value is None or value == ""):
        env_key = os.environ.get("LLM_API_KEY") or os.environ.get("VLM_API_KEY")
        if env_key:
            return env_key
    return value
